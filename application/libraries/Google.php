...
class Google{
    ...
    public function __construct(){
        ...
        require APPPATH .'third_party/google-api-client/src/Client.php';
        require APPPATH .'third_party/google-api-client/vendor/autoload.php';
        require APPPATH .'third_party/google-api-client/src/Service.php';
        ...
        $this->oauth2 = new Google_Service($this->client);
    }
